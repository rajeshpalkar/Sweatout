...
public class FragmentRecyclerView extends Fragment {
    ...
    private OnBodyPartListItemSelectedListener mListenerBodyPart;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mListenerBodyPart = (OnBodyPartListItemSelectedListener) getContext();
    }
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myRef = FirebaseDatabase.getInstance().getReference().child("moviedata").getRef();

        myFirebaseRecyclerViewAdapter = new MyFirebaseRecyclerViewAdapter(MovieDetails.class,R.layout.card_layout,
       ...
       // mLayoutManager = new LinearLayoutManager(getActivity());
              ...
              final  HashMap<String, ?> movie = (HashMap<String, ?>) movieData.getItem(position);
                ...
                ref.child(id).addListenerForSingleValueEvent(new com.google.firebase.database.ValueEventListener(){
                    ...
                    //    HashMap<String, String> movie =  (HashMap<String, String>) dataSnapshot.getValue();
                        mListenerBodyPart.onBodyPartListItemSelected(position,movie);
        ...
        String title = "Select Muscle";
        mListenerBodyPart.changeTileToDefault(title);
    ...
    public interface OnBodyPartListItemSelectedListener {
