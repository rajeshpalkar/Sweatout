...
public class FragmentRecyclerView5 extends Fragment {
    ...
    public FragmentRecyclerView5() {
        // Required empty public constructor
    }


    public static FragmentRecyclerView5 newInstance(int sectionNumber) {
        FragmentRecyclerView5 fragment = new FragmentRecyclerView5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String otherExercise = "SuspensionExe";

        myRef = FirebaseDatabase.getInstance().getReference().child("SuspensionExe").getRef();
