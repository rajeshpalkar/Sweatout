...
public class FragmentRecyclerView3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String otherExercise3 = "BattleropeExe";

        myRef = FirebaseDatabase.getInstance().getReference().child("BattleropeExe").getRef();
        ...
        myFirebaseRecyclerViewAdapter.setOnItemClickListener(new MyFirebaseRecyclerViewAdapter.OnItemClickListener(){
           ...
           //     String id = (String) movie.get("id");
            //    System.out.println("ID:"+id);
                ...
                myRef.child(otherExercise3).addListenerForSingleValueEvent(new com.google.firebase.database.ValueEventListener(){
