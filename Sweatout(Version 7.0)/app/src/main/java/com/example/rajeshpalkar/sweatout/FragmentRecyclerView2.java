...
public class FragmentRecyclerView2 extends Fragment {
   ...
   HashMap movie;
    ...
    public FragmentRecyclerView2() {
        // Required empty public constructor
    }


    public static FragmentRecyclerView2 newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String otherExercise2 = "BodyweightExe";

        myRef = FirebaseDatabase.getInstance().getReference().child("BodyweightExe").getRef();
            ...
            //    Toast.makeText(getActivity(), "inadshjashbdhska", Toast.LENGTH_SHORT).show();
             ...
             //   String id = (String) movie.get("id");
              ...
              //  DatabaseReference ref = movieData.getFireBaseRef();
                myRef.child(otherExercise2).addListenerForSingleValueEvent(new com.google.firebase.database.ValueEventListener(){

                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                      //  movie =  (HashMap<String, String>) dataSnapshot.getValue();
                   //     System.out.println("MOOOOO:"+movie);
                        System.out.println("OTHER:"+otherExercise2);
